...
// Update these with your real receiving details.
const MANUAL_PAYMENT_DETAILS = {
  bank: { name: 'Vyeta Digital Solutions', bank: 'Your Bank Name', account: '0000000000', branch: 'Your Branch' },
  mobileMoney: { name: 'Vyeta Digital Solutions', number: '097xxxxxxx' }
};
                  ...
                  <form onSubmit={submitManualPayment} className="space-y-4">
                    <div className="rounded-xl bg-emerald-500/5 border border-emerald-500/20 p-4 space-y-2 text-sm">
                      <div className="flex items-center gap-2 font-bold text-emerald-600 dark:text-emerald-400">
                        <Landmark className="w-4 h-4" /> Pay via bank transfer or mobile money
                      </div>
                      <p className="text-slate-600 dark:text-slate-300">
                        <strong>Mobile Money:</strong> {MANUAL_PAYMENT_DETAILS.mobileMoney.number} ({MANUAL_PAYMENT_DETAILS.mobileMoney.name})
                      </p>
                      <p className="text-slate-600 dark:text-slate-300">
                        <strong>Bank:</strong> {MANUAL_PAYMENT_DETAILS.bank.bank}, Acc {MANUAL_PAYMENT_DETAILS.bank.account}, {MANUAL_PAYMENT_DETAILS.bank.branch}
                      </p>
