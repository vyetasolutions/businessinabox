...
cat > frontend/src/pages/Billing.jsx << 'FILE_END'
...
git commit -m "Add manual payment option to Billing"
git push

echo "Done — check Render's Auto-Deploy setting on the vyetasuite static site to confirm it picks this up."
